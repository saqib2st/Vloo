...
class SelectScreenToBroadCast extends GetView<TemplatesController> {
  const SelectScreenToBroadCast({super.key,required this.orientations});
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: GestureDetector(
              onTap: ()=> Get.back(),
              child: SvgPicture.asset(StaticAssets.backButton,height: 20,),
            ),
          ),
          title: Text(
            'Select Screen'.tr,
              ...
              children: [
                ...
                Expanded(
                  child: SmartRefresher(
                    reverse: false,
                    enablePullDown: true,
                    controller: controller.refreshControllerSelectScreen,
                    onRefresh: (){
                      controller.onRefreshSelectScreen(orientations);
                    },
                    child: GridView(
                      shrinkWrap: true,
                      gridDelegate:
                        ...
                        ...List.generate(controller.screenList.length, (index) {
                          return InkWell(
                            ...
                            onTap: () async{
                              ...
                              controller.selectedScreenModel.value  = controller.screenList[index];
                              await Future.delayed(const Duration(milliseconds: 200));
                              controller.addMyScreenContent(screenId: controller.screenList[index].id,templateId: controller.editTemplateModel?.id);
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  border: Border.all(
                                      color: controller.selectedScreenModel.value == controller.screenList[index]?AppColor.appSkyBlue:
