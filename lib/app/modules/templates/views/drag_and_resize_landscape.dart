...
class DragAndResizeViewLandScape extends GetView<TemplatesController> {
  final String? comingFrom;

  const DragAndResizeViewLandScape({super.key, this.comingFrom});
      ...
      () => Scaffold(
        ...
        appBar: SecondaryAppbar(
              ...
              if (controller.editTemplateModel?.id == null) {
                Utils.confirmationAlert(
                    ...
                    onPressedPositive: () async {
                      ...
                      if (
                      await controller.createCanvaTemplateAPI(Strings.landscape, controller.editTemplateModel?.id ?? 0,resetTemplate: false)) {
                      ...
                      controller.getUserSubscriptionPlan(Strings.landscape);
                    },
                    onPressedNegative: () {
                      Get.back();
                    });
                ...
                await controller.getUserSubscriptionPlan(Strings.landscape);
              }
            }
          },
          onUndoPressed: () {
          ...
          onEyePressed: () async {
            if (controller.singleItemList.isNotEmpty) {
              controller.deSelectAllExceptLastNEntries(0);
              controller.toPreviewTemplates(14.w / 9.h, Strings.landscape);
            }
          },
          onBackPressed: () => {
            ...
            if (controller.singleItemList.isNotEmpty && controller.historySingleItemList.length > 1)
              {
                ...
                Utils.confirmationAlert(
                    ...
                    onPressedNegative: () async {
                      controller.ongoingBack(Strings.landscape, comingFrom);
                      Get.back();
                      Get.find<BottomNavController>().currentIndex.value = 1;
                    })
              }
            else
              {Get.back(), controller.resetEmptyCanvaTemplate()}
          },
        ),
        body: Stack(
          children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // if (comingFrom == Strings.editTemplate)        // On client feedback show options for create case also
                        GestureDetector(
                          onTap: () async {
                            ...
                            controller.title.value = await Get.to(()=>OptionsView(
                              ...
                              orientation: OrientationType.Landscape.name,
                            )) ?? '';
                          },
                          ...
                          child: Align(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () => controller.toImageElementView(Strings.landscape, Strings.addElementImage, 0),
                                  ...
                                  GestureDetector(
                                    onTap: () => controller.toAddTitleElementView(Strings.landscape, Strings.addElementTitle, 0),
                                    child: CustomRowTemplate(
                                      text: 'title'.tr,
                                  ...
                                  GestureDetector(
                                    onTap: () => controller.toDescriptionElementView(Strings.landscape, Strings.addElementDescription, 0),
                                    child: CustomRowTemplate(
                                      text: 'description'.tr,
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      controller.toPriceElementView(Strings.landscape, Strings.addElementPrice, 0);
                                    },
                                    child: CustomRowTemplate(
                                      text: 'price'.tr,
