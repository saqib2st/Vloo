...
import 'package:vloo/app/modules/imageElement/views/add_image_moves_screen.dart';
...
class AddImageTransitionScreen extends GetView<ImageElementController> {
  const AddImageTransitionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PrimaryAppbar(
        title: Strings.chooseTransitions,
        onPressed: () {
          controller.isBackgroundRemoved.value = false;
          controller.processedImageBytes.value?.clear();
          Get.back();
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          SvgPicture.asset(StaticAssets.transitionsIcon, colorFilter: const ColorFilter.mode(AppColor.appLightBlue, BlendMode.srcIn), width: 25.w, height: 25.h),
                          SizedBox(width: 5.w),
                          Text(
                            Strings.transitions,
                                        ...
                                        (e) => e.value.text == "None"
                                            ? GestureDetector(
                                                onTap: () {
                                                  ...
                                                  Get.to(const AddImageMovesScreen());
                                                },
                                                child: Container(
                                                  height: 70,
                                                  width: 180.w,
