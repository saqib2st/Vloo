import 'package:vloo/app/data/models/element/element.dart';
...
class AddElementResponse {
  ...
  AddElementResponse.fromJson(dynamic json) {
    status = json['status'];
    message = json['message'];
    if (json['result'] != null) {
      result = Elements.fromJson(json['result']);
    }
  }
  num? status;
  String? message;
